...
/*   Updated: 2024/03/27 13:46:21 by nsidqi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	img(char s, int l, t_var *var)
{
	...
	if (s == '1')
		...
		mlx_put_image_to_window(var->mlx, var->mlx_win, var->p_right, x, y);
	else if (s == 'C')
		mlx_put_image_to_window(var->mlx, var->mlx_win, var->collect, x, y);
	else if (s == 'M')
		mlx_put_image_to_window(var->mlx, var->mlx_win, var->enemy, x, y);
	x += IMG_X;
}
